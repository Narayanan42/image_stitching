% Load images.
muralDir = 'home/nanu/eece5554/LAB5/Data/mural/15-overlap';
...
[y,x,m] = harris(gray,5000, 'tile',[2 2],'disp');
[features, points] = extractFeatures(gray,[x,y]);

% Initialize features for I(1)
% grayImage = im2gray(I);
% [features, points] = harris(grayImage,points);
...
for n = 2:numImages
    ...
    [yn, xn, m] = harris(gray,5000, 'tile',[2 2],'disp');
    [features, points] = extractFeatures(gray,[xn,yn]);
